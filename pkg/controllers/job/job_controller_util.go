...
func createJobPod(job *batch.Job, template *v1.PodTemplateSpec, topologyPolicy batch.NumaPolicy, ix int,
	jobForwarding bool, envVarOverrides map[string]string) *v1.Pod {
